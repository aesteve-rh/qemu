...
/**
 * virtio_add_dmabuf() - Add a new dma-buf resource to the table
...
/**
 * virtio_remove_resource() - Removes a resource to the table
 * @uuid: resource's UUID
 *
 * Return: true if the UUID has been found and removed from the table.
 */
bool virtio_remove_resource(QemuUUID uuid);

/**
 * virtio_lookup_dmabuf() - Looks for a dma-buf resource on the table
 * @uuid: resource's UUID
 *
 ...
 * resources table, and frees them
 */
